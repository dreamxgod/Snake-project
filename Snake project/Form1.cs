...
namespace Snake_project
{
    public partial class Form1 : Form
    {
        ...
        private void StartGameMC(object sender, MouseEventArgs e)
        {
            //RestartGame();
        }
        ...
        private void PicBoxGraph(object sender, PaintEventArgs e)
        {
            ...
            canvas.FillEllipse(Brushes.IndianRed, new Rectangle
            (
